...
| FR-096 | Render Managed PostgreSQL                   | Must Have    | Production database provisioned as Render Managed PostgreSQL; connection string injected via `DATABASE_URL` environment variable                                            |
