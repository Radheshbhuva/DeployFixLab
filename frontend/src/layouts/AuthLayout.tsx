...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="h-screen w-screen max-h-screen overflow-hidden bg-[#070A11] text-slate-100 flex items-center justify-center p-2 sm:p-4 lg:p-6 relative font-sans select-none">
      ...
      <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[500px] h-[350px] bg-blue-600/10 blur-[130px] rounded-full pointer-events-none" />

      {/* Main Split-Screen Container Card */}
      <div className="relative z-10 w-full max-w-5xl h-auto max-h-[95vh] rounded-2xl border border-slate-800/80 bg-slate-900/70 backdrop-blur-2xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-center bg-slate-950/50 overflow-y-auto max-h-[95vh]">
